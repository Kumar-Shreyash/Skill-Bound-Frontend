  ...
  return (
    <footer className="bg-gray-900 text-gray-400 py-12 px-6 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        {/* Mission or Updates Section */}
        <div className="space-y-4">
          <h4 className="text-lg font-semibold text-white">Our Mission</h4>
          <p className="text-sm">
            We aim to democratize education by giving instructors and students the tools they need to teach, learn, and grow—anytime, anywhere.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>Phone: +1 (123) 456-XXXX</li>
            <li>Address: 123 Learning Lane, Skill City, SK 12345</li>
          </ul>

          <h4 className="text-lg font-semibold text-white mt-6">Follow Us</h4>
          <div className="flex space-x-4">
            ...
            <a href="https://x.com/Shreyash_si139" target='_blank' aria-label="Twitter" className="hover:text-green-500 transition-colors">
              <FaTwitter size={24} />
            </a>
            <a href="https://www.instagram.com/kumar_shreyash_/" target='_blank' aria-label="Instagram" className="hover:text-green-500 transition-colors">
              <FaInstagram size={24} />
            </a>
            <a href="https://www.linkedin.com/in/kumar-shreyash-84079b205" target='_blank' aria-label="LinkedIn" className="hover:text-green-500 transition-colors">
              <FaLinkedin size={24} />
            </a>
          </div>
        </div>
